...
def cupy_mlp_neural_network(network_feature_sizes, training_loader, validation_loader, learning_rate, epochs):
    network_parameters = [[axons_initialization(network_feature_sizes[feature_idx], network_feature_sizes[feature_idx+1]), dentrites_initialization(network_feature_sizes[feature_idx+1])]
