...
from nn_utils.activation_functions import relu, leaky_relu
...
def reconstructed_activation_error(activation, axons):
    ...
    avg_reconstructed_error = cp.sum(cp.linalg.norm(neurons_reconstructed_error)**2) / activation.shape[-1]
