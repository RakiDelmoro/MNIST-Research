...
from cupy_mlp_models.custom_model import custom_model_v1
...
def main():
    ...
    custom_model_v1(NETWORK_ARCHITECTURE, training_dataloader, validation_dataloader, LEARNING_RATE, EPOCHS)
