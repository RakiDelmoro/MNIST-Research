...
def main():
    ...
    model(network_architecture=NETWORK_ARCHITECTURE, training_loader=digit_generator(), validation_loader=validation_dataloader, learning_rate=LEARNING_RATE, epochs=EPOCHS)
